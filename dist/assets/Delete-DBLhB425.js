import{r as b,j as i}from"./index-CCADbRTz.js";import{h as w,i as k,d as x,e as S,g as M,s as R,m as $,w as m,x as f,l as A}from"./departments-Bm4J2WDc.js";import{c as p}from"./TextField-Bslyc8gM.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function j(t){return parseFloat(t)}function z(t){return w("MuiSkeleton",t)}k("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const E=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:r,height:o}=t;return M({root:["root",a,n,s&&"withChildren",s&&!r&&"fitContent",s&&!o&&"heightAuto"]},z,e)},l=m`
  0% {
    opacity: 1;
  }
